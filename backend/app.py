...
def initialize_model():
    ...
    try:
        ...
        # CRITICAL: Render Free Tier only has 512MB RAM.
        # TabPFN memory usage scales quadratically with training size.
        # Subsampling to 150 rows prevents the Out Of Memory (OOM) crash.
        X_train = X_train.head(150)
        y_train = y_train.head(150)
